...
class FbReactionState extends State<FbReaction> with TickerProviderStateMixin {
  ...
  late Animation pushIconLikeUp, pushIconLoveUp, pushIconAngryUp;
  late Animation zoomIconLike, zoomIconLove, zoomIconAngry;
  ...
  initAnimationBoxAndIcons() {
    ...
    // General
    moveRightGroupIcon = Tween(begin: 0.0, end: 20.0).animate(
  ...
  initAnimationIconWhenRelease() {
    ...
    moveLeftIconAngryWhenRelease = Tween(begin: 116.0, end: 10.0).animate(
        CurvedAnimation(
            parent: animControlIconWhenRelease, curve: Curves.decelerate));
  ...
  void setForwardValue() {
    ...
    pushIconLoveUp = Tween(begin: 30.0, end: 60.0).animate(
      CurvedAnimation(parent: animControlBox, curve: const Interval(0.1, 0.7)),
    );
    zoomIconLove = Tween(begin: 0.0, end: 1.0).animate(
      CurvedAnimation(parent: animControlBox, curve: const Interval(0.1, 0.7)),
    );
